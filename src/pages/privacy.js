...
import { H2, H3, H4, Text } from "../components/text"
        ...
        <ol type="A">
          ...
          <li>
            ...
            <Text>
              <ul>
                <li>
                  ...
                  service provider), your company, or your university;
                </li>
            ...
            <Text>
              ...
              such as cookies, web beacons, and other technologies. Third-party
              providers, advertisers, and/or partners may also view, edit, or
              set their own cookies or place web beacons. The use of these
              technologies by such third parties is subject to their own privacy
              policies and is not covered by this Website Privacy Policy, except
              as required by law.
            </Text>
            <Text>
            ...
            <Text>
              <ol type="a">
                <li>
                  “Cookies” are small digital files that are transferred to your
                  computer or smartphone’s hard drive when you visit a website
                  or click on a URL. Cookies allow us to operate and personalize
                  the Website, assist with functionality of the Website, to
                  track your usage, and to deliver targeted advertisements to
                  you. “Session Variables” are similar to Cookies except that
                  they remain on our servers and are not transferred to your
                  computer or smartphone. Usage of a Cookie or Session Variable
                  is in no way linked to your name or address. Once you close
                  your Web browser, the Cookie or Session Variable simply
                  terminates. If you reject the Cookie or Session Variable, you
                  may still use the Website.
                  <ul>
                    <li>
                      Most web browsers automatically accept cookies, unless you
                      have configured yours not to accept them. You can program
                      your browser not to accept cookies, but if you do, you may
                      not be able to use certain portions of the Website and the
                      Website will not be able to customize certain functions
                ...
                <li>
                  ...
                  visitors to the Website, monitor how you navigate the Website
                  or to count how many particular links posted on the Website
                  were actually viewed.
                </li>
                <li>
                  Our Website uses retargeting pixels from Google, Facebook and
                  other ad networks. Please visit their websites for their
                  privacy policies and consent and opt-out mechanisms, or visit
                  sties that may help block ad tracking, such as About Ads at
                  http://optout.aboutads.info/“Log Files” track actions
                ...
                <li>
                  ...
                  help provide us with information about traffic to our Website.
                  These services use the data collected to track and monitor the
                  use of our Website, which it shares with other services and
                  websites who use the collected data to contextualize and
          ...
          <li>
            ...
            <Text>
              ...
              Facebook, Twitter, Instagram, SnapChat (“Social Media Platforms”),
              and/or sources providing publicly-available information (e.g.,
              from the U.S. Postal Service) to help us provide services to you,
              help prevent fraud, and for marketing and advertising purposes.
            </Text>
            <Text>
              Information we may access about you, with your consent, may
              include, but is not limited to, your basic Social Media Platform
              information, your location data, your list of contacts, friends or
              followers and certain information about your activities on the
              Social Media Platform. Please keep in mind that when you provide
              Information to us on a third-party website or platform, the
              Information you provide may be separately collected by the
            ...
            <Text>
              ...
              platform’s privacy policies. We encourage you to be aware when you
              leave our sites or applications and to read the privacy policies
              of other sites that may collect your Information.
            </Text>
          </li>
        </ol>
        ...
        <ol type="A">
          <li>
            ...
            <Text>
              <ul>
                <li>
                  Provide you with the Website’s Services and related products,
                  promotions, newsletters, and information you request;
                </li>
                <li>
                ...
                <li>
                  For marketing and advertising purposes, including sending you
                  promotional material or special offers on our behalf or on
                  behalf of our marketing partners and/or their respective
                  affiliates and subsidiaries and other third parties, provided
                  that you have not already opted-out of receiving such
                  communications;
                </li>
                ...
                <li>
                  Comply with any applicable laws and regulations and respond to
          ...
          <li>
            ...
            <Text>
              We may disclose anonymized aggregated information about our users,
              that does not identify any individual, without any restriction.
            </Text>
            <Text>
              We may share your Information as set forth in the Website Privacy
            ...
            <Text>
              <ul>
                <li>
                  ...
                  your Information with third-party service providers that
                  perform certain functions or services on our behalf (such as
                  to host the Services, fulfill orders, provide products and
                  services, manage databases, perform analyses, process credit
                  card payments, provide customer service, or send
                  communications for us). These third-party service providers
                  are authorized to use your Information only as necessary to
                  provide these services to us. In some instances, we may
                  aggregate Information we collect so third parties do not have
                  access to your particular Information to identify you
                  individually.
                </li>
                <li>
                  <strong>
                  ...
                  limitation, requests from the governmental agency authorities
                  to view your Information); (iv) to protect and defend the
                  rights, property or safety of us, our subsidiaries and
                  affiliates and any of their officers, directors, employees,
                  attorneys, agents, contractors and partners, and the Website
                  Service users; (v) to enforce or apply our Terms &amp;
                  Conditions; and (vi) to verify the identity of the user of our
                  Services.
                </li>
                <li>
                  ...
                  another business entity; (ii) sell all or substantially all of
                  our assets; (iii) are adjudicated bankrupt; or (iv) are
                ...
                <li>
                  <strong>
                    Online Communications (Chat Rooms, Forums, Contests, Message
                    Boards).
                  </strong>
                  If you correspond with us by email, questionnaires, surveys,
                  social media, or other digital online platform, we may retain
                  such correspondence and the Information contained in it and
                  use it to respond to your inquiry. Our Services may include
                  chat rooms, forums, and message boards that are available to
                  you and other users. You are not required to provide any
                  Information when using these areas, but you may choose to do
                  so. If you post personal Information online, you agree you
                  have no expectation of privacy concerning that Information,
                  that it will be publicly available and that you may receive
                  unsolicited messages from other parties. We cannot ensure the
                  security of any Information you choose to make public in a
                  chat room, forum, or message board. Also, we cannot ensure
                  that parties who have access to such publicly available
                  Information will respect your privacy. Please exercise caution
                  when deciding to disclose Information in these areas. To
                  request removal of your personal Information from our blog or
                  community forum, contact us at Contact@ShopBotanist.com. In
                  some cases, we may not be able to remove your Information, in
                  which case we will let you know if we are unable to do so and
                  why.
                </li>
                <li>
                  <strong>With Your Consent.</strong> We may share Information
                  consistent with this Website Privacy Policy with your consent.
                </li>
              </ul>
            </Text>
          </li>
